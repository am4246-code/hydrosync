  ...
  return (
    <div className="privacy-policy-container">
      ...
      <ul>
        ...
        <li>
          <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Hydrosync.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Hydrosync, accessible from <a href="https://www.hydrosync.com">https://www.hydrosync.com</a>
        </li>
        <li>
      ...
      <ul>
        <li>By email: privacy@hydrosync.com</li>
      </ul>
    </div>
  );
};
